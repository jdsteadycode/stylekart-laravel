...
<div class="p-8">
    ...
    <div class="mb-6 flex flex-wrap gap-4">
        ...
        <a
            ...
            class="inline-flex items-center px-4 py-2 rounded-lg font-semibold text-sm {{ request()->query('status') === 'pending' ? 'bg-gray-500 text-white' : 'bg-gray-100 text-gray-800'}}">
