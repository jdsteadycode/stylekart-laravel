{{-- resources/views/vendor/discounts/create.blade.php --}}
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-6">
        ...
        {{-- 🚀 x-data holds the state for our dynamic dropdowns --}}
        <form action="{{ route('vendor.discounts.store') }}" method="POST" x-data="{ targetType: '{{ old('target_type', 'product') }}' }">
            @csrf
            ...
            {{-- 4. Target Type (The Alpine.js trigger!) --}}
