...
class ProductVariantRequest extends FormRequest
{
    ...
    {
        // log the action
        logger()->info("[Modules\Product\app\Http\Requests\ProductVariantRequest@authorize] Authorization initiated");
    ...
    {
        // log the action
        logger()->info("[Modules\Product\app\Http\Requests\ProductVariantRequest@rules] Validation initiated");
