...
class ProductVariantController extends Controller
{
    ...
    */
    public function create(Product $product)
    {
        // log the action
        Log::info(
            "[Module\Product\app\Http\Controllers\Vendor\ProductVariantController@create] Product Variant creation begins",
        );

        abort_if($product->vendor_id !== auth()->id(), 403);

        return view("product::vendor.products.variants.create", compact("product"));
    }
    /*
    ...
    */
    public function store(ProductVariantRequest $request, Product $product)
    {
        // log the action
        Log::info(
            "[Modules\Product\app\Http\Controllers\Vendor\ProductVariantController@store] Product Variant addon begins"
        );
        ...
        $colorName = $product->colors()->where('id', $request->color_id)->pluck('name')->first();
        ...
        $created = $product->variants()->updateOrCreate(
            ...
            [
                ...
                $request->price == 0
                    ...
                    : $request->price,
                "stock" => $request->stock,
                "sku" => "{$productName}-{$request->size}-{$colorName}"
            ],
        );
    ...
    */
    public function edit(Product $product, ProductVariant $variant)
    {
        // log the action
        Log::info(
            "[Modules\Product\app\Http\Controllers\Vendor\ProductVariantController@update] Product Variant Edit begins",
        );
        ...
        return view("product::vendor.products.variants.edit", compact("product", "variant"));
    }
    ...
    */
    public function update(
        ...
        // log the action
        Log::info(
            "[Modules\Product\app\Http\Controllers\Vendor\ProductVariantController@update] Product Variant Update begins",
        );
    ...
    */
    public function destroy(Product $product, ProductVariant $variant)
    {
        // log the action
        Log::info(
            "[Modules\Product\app\Http\Controllers\Vendor\ProductVariantController@destroy] Product Variant Deletion begins",
        );
