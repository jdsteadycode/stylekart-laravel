...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <!-- Back to Product -->
    <div>
        <a href="{{ route('module.vendor.products.show', $color->product) }}"
    ...
    <div class="bg-white border rounded-lg p-6">
        ...
        <!-- Upload New Images -->
        <form action="{{ route('module.vendor.products.colors.images.store', [$product, $color]) }}"
              method="POST"
                ...
                @foreach($color->getMedia('color_images') as $media)
                    <div class="flex flex-col items-center border p-2 rounded group hover:shadow-md transition-shadow duration-200">
                        ...
                        <div class="flex gap-1">
                            ...
                            <!-- Replace Image -->
                            <form action="{{ route('module.vendor.products.colors.images.update', ['product'=>$product, 'color'=>$color, 'media'=>$media]) }}"
                                  method="POST"
                                  enctype="multipart/form-data"
                            ...
                            <!-- Delete Image -->
                            <form action="{{ route('module.vendor.products.colors.images.destroy', ['product'=>$product, 'color'=>$color, 'media'=>$media]) }}"
                                  method="POST"
