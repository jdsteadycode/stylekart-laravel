...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div>
        <a href="{{ route('module.vendor.products.show', $product) }}"
    ...
    <div class="bg-white border rounded-lg p-6">
        ...
        <form action="{{ route('module.vendor.products.variants.update', [$product, $variant]) }}"
              method="POST"
              class="space-y-6">
            ...
            {{-- Fix: Removed SKU field (Now handled automatically in backend) --}}
            {{-- <div>
