...
<div class="max-w-5xl mx-auto space-y-8">
    ...
    <div class="bg-white border rounded-lg p-6">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('module.vendor.products.colors.create', $product) }}"
                ...
                @foreach($product->colors as $color)
                    <div class="flex justify-between items-center border rounded-md px-4 py-3"
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <a
                                href="{{ route('module.vendor.products.colors.show', [$product, $color]) }}"
                            >
                        ...
                        <div class="space-x-3 text-sm" x-data="{open: false}">
                            <a href="{{ route('module.vendor.products.colors.edit', [$product, $color]) }}"
                               class="text-orange-600 hover:underline">
                                Edit
                            </a>

                            <x-admin.delete-modal
                                action="{{ route('module.vendor.products.colors.destroy', [$product, $color]) }}"
