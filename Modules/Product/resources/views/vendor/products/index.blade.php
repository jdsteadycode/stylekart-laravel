@extends('product::vendor.layouts.app')
...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('module.vendor.products.create') }}"
                ...
                <tr>
                    ...
                    <td class="px-4 py-3 font-medium">
                        <a
                            ...
                            href="{{ route('module.vendor.products.show', $product) }}"
                        >
                            {{ $product->name }}
                        </a>
                    </td>
                    ...
                    <td class="px-4 py-3 space-x-3" x-data="{ open: false }">
                        ...
                        <a href="{{ route('module.vendor.products.edit', $product) }}"
                           class="text-yellow-600 hover:underline">
                            Edit
                        </a>

                        <x-admin.delete-modal
                            action="{{ route('module.vendor.products.destroy', $product) }}"
                            title="{{ 'Are you sure?'}}"
